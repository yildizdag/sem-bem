...
load rhinodata_RectPanelwCutout
...
rho_plate = 2700;       % density [kg/m3]
E_plate = 69e9;         % Elastic modulus [Pa]
pois_plate = 0.33;      % Poisson's ratio
...
BC.edgenodes = [1 76; 1 5; 5 80; 76 80];
