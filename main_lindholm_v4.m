...
h_plate = 0.1;                  % thickness of the host structure (m)
% Boundary conditions
...
domNorm = ((((12*(1-pois_plate^2))*rho_plate*h_plate*(2^4))/E_plate/(h_plate^3)).*((wns(1:20)).^2)).^0.5;
...
% % % %     end
% % % % end
% % phi = ((eye(countBEM,countBEM)+C)-H)\(G*b);
